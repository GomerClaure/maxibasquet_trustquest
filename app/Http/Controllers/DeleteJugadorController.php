...
class DeleteJugadorController extends Controller
{
    public function index()
    {
        ...
        return view('editarJugadores.listadeletejugador', compact('arreglo'));
    }
    ...
    public function show($equipo, $categoria)
    {
        ...
        $deleteJugador=[];
        return view('editarJugadores.listadeletejugador', compact('jugadores', 'equipo', 'categoria','deleteJugador'));
    }
