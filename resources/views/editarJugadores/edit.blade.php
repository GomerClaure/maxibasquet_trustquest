...
<body class="antialiased">
    ...
    <div class="col-7 p-4 mx-auto contenedorForm">
        <form action="{{ url('/editarJugadores/'.$id)}}" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-4" id="columna3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-select" id="selectSexo" name="selectSexo" value="{{ $datos->SexoPersona }}">
            ...
            <div class="row">
                ...
                <div class="form-group mb-6 col-6">
                    ...
                    <img src="{{asset('storage').'/'.$datos->Foto}}" name="foto" width="380" height="350">
                ...
                <div class="form-group mb-6 col-6">
                    ...
                    <img src="{{asset('storage').'/'.$datos->FotoCarnet}}" name="foto" width="380" height="350">
            ...
            <div class="d-flex justify-content-center mt-3 mb-3">
                <a href="{{ url('editarJugadores/'.$datos->NombreEquipo.'/'.$datos->NombreCategoria) }}" class="btn btnFomulario">Cancelar</a>
