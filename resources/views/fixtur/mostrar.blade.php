...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/StyleFixtur.css')}}">
</head>
                                        ...
                                        <table class="table table-striped table-borderless border-dark  mb-0 text-center align-middle">
                                            ...
                                            <tbody>
                                                @for ($i=0;$i<sizeof($partidos);$i++) 
                                                    <tr>
                                                    @if($i+1!=sizeof($partidos))
                                                        @if($partidos[$i]->NombreEquipo!=$partidos[$i+1]->NombreEquipo)
                                                             <td>{{$partidos[$i]->NombreEquipo}} vs {{$partidos[$i+1]->NombreEquipo}}</td>
                                                        @endif
                                                        @if($partidos[$i]->LugarPartido==$partidos[$i+1]->LugarPartido)
                                                             <td>{{$partidos[$i]->LugarPartido}}</td>
                                                        @endif
                                                        @if($partidos[$i]->FechaPartido==$partidos[$i+1]->FechaPartido)
                                                             <td>{{$partidos[$i]->FechaPartido}}</td>
                                                        @endif
                                                        @if($partidos[$i]->HoraPartido==$partidos[$i+1]->HoraPartido)
                                                             <td>{{$partidos[$i]->HoraPartido}}</td>
                                                        @endif
                                                    @endif
                                                    </tr>
                                                @endfor
